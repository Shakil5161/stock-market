    ...
    <div id="yearlyGoal" className="container m-auto" data-aos='zoom-in'>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 ">
        ...
        <div className="bg-white dark:bg-gray-800 rounded shadow p-6">
          <div className="flex items-center justify-between w-full sm:w-full mb-8">
            <div className="flex items-center">
              <div className="p-4 bg-blue-200 rounded-lg animate__animated animate__pulse animate__infinite animate__slow">
                <svg
        ...
        <div className="bg-white dark:bg-gray-800 rounded shadow p-6">
          <div className="flex items-center justify-between w-full sm:w-full mb-8">
            <div className="flex items-center">
              <div className="p-4 bg-green-200 rounded-lg animate__animated animate__pulse animate__infinite animate__slow">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
