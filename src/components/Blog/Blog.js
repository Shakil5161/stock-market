    ...
    return (
        <>
            ...
            <div className="lg:flex md:flex xl:justify-around sm:flex flex-wrap md:justify-around sm:justify-around lg:justify-around pt-8">
                <div className="xl:w-1/3 sm:w-5/12 sm:max-w-xs relative pb-16 lg:pb-10 xl:max-w-sm  lg:w-1/2 w-11/12 mx-auto sm:mx-0" data-aos='slide-right' data-duration='1500'>
                ...
                <div className="xl:w-1/3 sm:w-5/12 sm:max-w-xs relative pb-16 lg:pb-10 xl:max-w-sm lg:w-1/2 w-11/12 mx-auto sm:mx-0" data-aos='zoom-in'>
                ...
                <div className="xl:w-1/3 sm:w-5/12 sm:max-w-xs relative pb-16 lg:pb-10 xl:max-w-sm lg:w-1/2 w-11/12 mx-auto sm:mx-0" data-aos='slide-left' data-duration='1500'>
                    <div className="shadow h-64 rounded">
