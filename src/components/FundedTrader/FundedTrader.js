            ...
            <div className="w-90%">
              ...
              <div className="w-4/5 mx-auto pb-12" data-aos="zoom-in">
                <h1 className="xl:text-5xl pt-4 xl:pt-0 text-3xl text-white text-center font-extrabold mb-4">
                  What is <br />{" "}
                  <span className="myColor">Funded Trader Program?</span>
                </h1>
                <p className="text-xl text-center text-gray-300 leading-normal">
                  A funded trader program is designed for traders who have
                  skills and experience but are lacking enough capital to make
                  trading full time profitable.
                </p>
              </div>
              <div
              ...
              >
                ...
                data-aos-duration="800">
                  ...
                  <p className="text-gray-200 pt-5 ">
                    Funded trader programs allow you to leverage your trading
                    skills and increase your earning potential without spending
                    your own hard ear- ned money.
                  </p>
              ...
              <div className="flex flex-col lg:flex-row mx-auto w-full bg-transparent">
                ...
                >
                  ...
                  <p className="text-gray-200 pt-5">
                    Funded trader program is designed to help po- tential
                    traders like you to grow their skills, and help you rise to
                    the top in the FX market.
                  </p>
                </div>
                <div className="w-full lg:w-2/4 p-6 border-t border-b lg:border-t-0 lg:border-b-0 sm:border-l border-gray-300">
                  <div data-aos="fade-left" data-aos-duration="1200">
                    ...
                    <p className="text-gray-200 pt-5">
                      The ultimate goal of a funded trader program is to empower
                      traders and enable driven indiv- iduals to become
