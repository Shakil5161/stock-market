...
const OurClient = () => {
  return (
    <>
      <div className="w-full dark:bg-gray-900 py-36">
          ...
          <div className="w-90%" data-aos='zoom-in' data-duration="1200">
            ...
            <div className="w-4/5 mx-auto pb-12">
              ...
              <p className="text-xl text-center text-gray-600 leading-normal">
                We grow when your business does.
              </p>
            </div>
              ...
              <div className="w-full lg:w-1/3 p-6">
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded shadow">
                    <img
                      className="w-full h-full overflow-hidden object-cover animate__animated animate__pulse animate__infinite"
                      src={logo}
                      alt="logo"
                    />
                  </div>
